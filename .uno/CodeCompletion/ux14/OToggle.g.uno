...
public partial class OToggle: Fuse.Controls.Panel
{
    ...
    void InitializeUX()
    {
        ...
        var temp25 = new global::Fuse.Reactive.DataBinding(handle_Color_inst, temp9, Fuse.Reactive.BindingMode.Read);
        ...
        this.PrimaryColor = float4(0.4862745f, 0.509804f, 0.9568627f, 1f);
        ...
        queueNum.X = new Uno.UX.Size(30f, Uno.UX.Unit.Unspecified);
        ...
        reserveNum.X = new Uno.UX.Size(-35f, Uno.UX.Unit.Unspecified);
        reserveNum.Name = __selector4;
        reserveNum.Bindings.Add(temp23);
        handle.CornerRadius = float4(25f, 25f, 25f, 25f);
        handle.Width = new Uno.UX.Size(66f, Uno.UX.Unit.Unspecified);
        handle.Height = new Uno.UX.Size(37f, Uno.UX.Unit.Unspecified);
        ...
        temp24.Distance = 1f;
        temp24.Size = 1f;
        temp24.Color = float4(0f, 0f, 0f, 0.2666667f);
        background.CornerRadius = float4(24f, 24f, 24f, 24f);
        background.Height = new Uno.UX.Size(37f, Uno.UX.Unit.Unspecified);
